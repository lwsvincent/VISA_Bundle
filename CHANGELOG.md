...
### Fixed
- Wrap `clear()` in try-except to ignore unsupported VISA command on Chroma models (#3)

## [2.0.3] - 2026-04-10

### Changed
- Disable stub generation in pyc_config to fix project/package name collision bug
- Set model to haiku for release-pyc skill
